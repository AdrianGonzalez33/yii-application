...
<div class="page-header">
    <div class="page-header-bg" style='background-image: url("<?php echo $objeto[0]->imagen?>"); data-stellar-background-ratio="0.5"; background-repeat:no-repeat; background-size: 100% 100%; width:1130px; ' ></div>
    <div class="container">
        <div class="row">
            <div class="col-md-offset-1 col-md-10 text-center">
                <h1 class="text-uppercase"><?= $categoria ?></h1>
            </div>
        </div>
    </div>
</div>
...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <?php
                $ultimoArticulo = array_slice((array) $articulos, 0,1);// ultimo post de la categoria
                ?>
                <?php foreach($ultimoArticulo as $row): ?>
                    <!-- post -->
                    <div class="post post-thumb">
                        ...
                        <div class="post-body">
                            ...
                            <h3 class="post-title title-lg"><a href="<?= Url::toRoute(["articulo/post", "id_articulo"=>$row->id_articulo])?>"><?=$row->titulo ?></a></h3>
                            <ul class="post-meta">
                ...
                <div class="row">
                    <?php
                    $ultimosArticulos = array_slice((array) $articulos, 1,4);// ultimos post de la categoria
                    ?>
                ...
                <?php Pjax::begin(); ?>
                <?php
                $restoArticulos = array_slice((array) $articulos, 5, $numArticulos);// resto de articulos de la categoria
                ?>
                <?php foreach($restoArticulos as $row): ?>
                    <!-- post -->
                ...
                <div class="section-row loadmore text-center">
                    <?php if($numArticulos+1 > sizeof($articulos)-4 || $numArticulos+1 == sizeof($articulos)-4 ){
                        echo "<p></p>";
                    }else{
                        echo Html::a("Cargar Más", ['articulo/category/'.$categoria,'numArticulos' => $numArticulos+1], ['class' => 'btn btn-lg primary-button']);}
                    ?>
                </div>
            </div>
            <div class="col-md-4">
