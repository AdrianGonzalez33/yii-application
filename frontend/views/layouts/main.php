...
<div class="wrap">
    ...
    'options' => [
        'class' => 'navbar-default navbar-fixed-top navbar-right',
        ],
    ]);
    $menuItems = [
        ['label' => 'Blog', 'url' => ['articulo/index']],
        ['label' => 'Atención al cliente', 'url' => 'https://www.recordrentacar.com/es/recordgo-contacto/'],
...
<!-- footer -->
<footer class="page-footer bg-dark font-small mdb-color pt-4" style=" left: 0;  bottom: 0;  width: 100%; text-align: center;">
    <section class="links">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
